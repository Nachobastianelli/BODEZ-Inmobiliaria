  ...
  return (
    <div className="w-full h-screen flex flex-col lg:flex-row items-center justify-center space-y-16 lg:space-y-0 space-x-8 2xl:space-x-0">
      <div className="w-full lg:w-1/2 flex flex-col items-center justify-center lg:px-2 xl:px-0 text-center">
        <p className="text-7xl md:text-8xl lg:text-9xl font-bold tracking-wider text-red-900">
          404
        </p>
        ...
        <a
          href="/home"
          className="flex items-center space-x-2 bg-red-900 hover:bg-red-950 text-gray-100 px-4 py-2 rounded transition duration-150"
          title="Return Home"
        >
          <svg
